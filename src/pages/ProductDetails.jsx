...
const SERVICES_DATA = {
  1: {
    ...
    fullDescription:
      "В нашей компании вы можете заказать услуги по подключению бытовой техники по доступным ценам. Принимаем заказы на проведение работ любого уровня сложности: от подключения стиральной машины до установки встроенной техники. Предлагаем выгодные расценки на подключение бытовой техники в Донецке на 2026 год.",
    features: [
  ...
  3: {
    ...
    fullDescription:
      "В нашей компании вы можете заказать услуги сантехника по доступным ценам. Принимаем заказы на проведение работ любого уровня сложности: от замены прокладки в кране до монтажа системы водоснабжения в доме. Предлагаем выгодные расценки на сантехнические работы в Донецке на 2026 год.",
    features: [
          ...
          <div className="service-intro-content">
            ...
            <div className="service-intro-description">
              <p>
                ...
                сантехнические работы в Донецке на 2026 год.
              </p>
            </div>
          </div>
        </div>
